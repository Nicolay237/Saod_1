...
<img width="973" height="485" alt="image" src="https://github.com/user-attachments/assets/e77a03ed-fade-4791-b3d9-5dc190bb869e" />
...
- - `few_numbers.txt`: Содержит 10,000 случайных целых чисел (от 0 до 1,000,000). Первая строка — количество чисел n, затем n чисел, каждое на новой строке.
- `few_people.txt`: Содержит 10,000 записей о людях. Первая строка — количество записей m, затем m строк с фамилией, именем и отчеством, выбранными случайным образом из заранее заданных списков.

**Особенности генерации:**
- Используется генератор случайных чисел `std::mt19937` для обеспечения высокого качества случайных данных
- Прогресс генерации отображается каждые 10%, с указанием времени выполнения
...
```
<img width="975" height="520" alt="image" src="https://github.com/user-attachments/assets/73ed7805-f707-40f2-af56-f36bce6674e6" />

<img width="973" height="584" alt="image" src="https://github.com/user-attachments/assets/a9204d4f-742f-49dc-a708-0ac780f902ed" />
...
<img width="974" height="584" alt="image" src="https://github.com/user-attachments/assets/0404fe6a-af3b-40f5-acd9-89f313a94541" />
